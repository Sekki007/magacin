          ...
          <div className="flex flex-wrap gap-3">
            {isAdmin && (
              <>
                <a
                  href="/admin/prodaje"
                  className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 px-4 py-2 rounded-lg font-medium transition"
                >
                ...
                <div className="mt-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start gap-2">
                      <span className="font-medium text-green-600">Kolega:</span> vidi cene sa ugradnjom
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="font-medium text-orange-600">Serviser:</span> vidi cene bez ugradnje
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="font-medium text-gray-600">Lager:</span> vidi nabavne cene ekrana
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  {isAdmin && (
                    <div className="flex gap-3">
                      <button onClick={() => otvoriProdaju(art)} className="text-green-600 hover:text-green-800">
                        <ShoppingBagIcon className="w-6 h-6" />
                      </button>
                      <button onClick={() => otvoriRezervaciju(art)} className="text-orange-600 hover:text-orange-800">
                        <ClockIcon className="w-6 h-6" />
                      </button>
                      <button onClick={() => izmeniArtikal(art)} className="text-blue-600 hover:text-blue-800">
                        <PencilSquareIcon className="w-6 h-6" />
                      </button>
                      <button onClick={() => obrisiArtikal(art.id)} className="text-red-600 hover:text-red-800">
                        <TrashIcon className="w-6 h-6" />
                      </button>
                    </div>
                  )}
                </div>
                <p className="text-sm text-gray-600 mb-2">Unos: {new Date(art.created_at).toLocaleDateString('sr-RS')}</p>
            ...
            <table className="w-full">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="p-4 text-left">Datum unosa</th>
                  ...
                  <tr key={art.id} className="border-t hover:bg-gray-50 transition">
                    ...
                    {isAdmin && (
                      <td className="p-4 text-center space-x-4">
                        <button onClick={() => otvoriProdaju(art)} className="text-green-600 hover:text-green-800">
                          <ShoppingBagIcon className="w-6 h-6 inline" />
                        </button>
                        <button onClick={() => otvoriRezervaciju(art)} className="text-orange-600 hover:text-orange-800">
                          <ClockIcon className="w-6 h-6 inline" />
                        </button>
                        <button onClick={() => izmeniArtikal(art)} className="text-blue-600 hover:text-blue-800">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 mt-2">Nabavna cena: <span className="font-bold">{prodajaArtikal.osnovna_cena} €</span></p>
              </div>
              <div className="mb-8">
                ...
                <p className="text-right mt-3 text-lg">
                  Zarada: <span className="font-bold text-green-600">{(prodajaArtikal.osnovna_cena * prodajaKolicina).toFixed(2)} €</span>
                </p>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full">
              ...
              <div className="flex gap-4 mt-8">
                <button
                  ...
                  disabled={loading}
                  className="flex-1 bg-orange-600 hover:bg-orange-700 text-white py-4 px-8 rounded-lg font-bold transition flex items-center justify-center gap-3"
                >
                  <ClockIcon className="w-6 h-6" />
                  {loading ? 'Rezervacija u toku...' : 'Rezerviši'}
                </button>
                <button
                  onClick={() => setShowRezervacija(false)}
                  disabled={loading}
